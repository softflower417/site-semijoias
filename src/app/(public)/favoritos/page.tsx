...
export default function FavoritosPage() {
  ...
  useEffect(() => {
    async function fetchFavorites() {
      const ids: string[] = JSON.parse(localStorage.getItem('saona_favorites') || '[]');
  ...
  return (
    <div className="container mx-auto px-4 py-12 min-h-[60vh]">
      <h1 className="text-3xl font-serif text-brand-burgundy text-center mb-12 uppercase tracking-widest">Favoritos</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 space-y-6">
          ...
          <p className="text-gray-400 font-light">Você ainda não salvou nenhuma peça como favorita.</p>
          <Link
            href="/semijoias"
