      ...
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {[
            ...
            <Link href={`/semijoias?category=${cat.name}`} key={cat.name} className="group cursor-pointer">
              ...
              <h3 className="text-center text-brand-text uppercase tracking-widest text-sm">{cat.name}</h3>
            </Link>
          ))}
        </div>
      </section>
