    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 flex-col md:flex-row">
      ...
      <div className="md:hidden flex justify-between items-center bg-brand-burgundy text-brand-nude p-4 z-40 shadow-md">
        <div className="flex flex-col">
          <h2 className="font-serif text-xl tracking-widest leading-none">
            MAONA
          </h2>
        ...
        <div className="md:hidden fixed inset-0 z-50 bg-brand-burgundy flex flex-col text-brand-nude">
          ...
          <nav className="flex flex-col flex-1 px-6 py-8 space-y-4">
            <Link
              onClick={() => setMobileMenuOpen(false)}
              href="/admin/produtos"
              className={`flex items-center gap-4 px-4 py-4 rounded-md transition-colors ${pathname.includes("/admin/produtos") ? "bg-brand-gold text-white" : "hover:bg-white/10"}`}
            >
              <Package size={24} />
            ...
            <Link
              ...
              className={`flex items-center gap-4 px-4 py-4 rounded-md transition-colors ${pathname.includes("/admin/financeiro") ? "bg-brand-gold text-white" : "hover:bg-white/10"}`}
            >
              <DollarSign size={24} />
            ...
            <Link
              onClick={() => setMobileMenuOpen(false)}
              href="/admin/pedidos"
              className={`flex items-center gap-4 px-4 py-4 rounded-md transition-colors ${pathname.includes("/admin/pedidos") ? "bg-brand-gold text-white" : "hover:bg-white/10"}`}
            >
              <Inbox size={24} />
          ...
          <div className="p-6 border-t border-white/10">
            <button
              ...
              className="flex items-center gap-4 px-4 py-4 w-full rounded-md hover:bg-white/10 transition-colors text-left text-red-300"
            >
              <LogOut size={24} />
              <span className="text-lg">Sair do painel</span>
            </button>
          </div>
        </div>
      )}
      ...
      <aside className="hidden md:flex w-64 bg-brand-burgundy text-brand-nude flex-col z-50">
        <div className="p-6">
          <h2 className="font-serif text-2xl tracking-widest text-center">
            MAONA
          </h2>
          <p className="text-center text-xs opacity-70 mt-1 uppercase tracking-widest">
            Admin
          </p>
        </div>
